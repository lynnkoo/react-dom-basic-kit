...
const removePopupLayer = (rootNode) => {
...
export const enhancePopupComponent = (WrappedComponent, layerClassName) => (
  props,
) => {
  const { isOpen } = props
  ...
  return (
    ...
    React.createElement(
      ...
      React.createElement(
        WrappedComponent,
        Object.assign({}, props, { onRemove: onRemove }),
      ),
    )
  )
}
export function usePopupShown(isOpen = true) {
...
export function usePopupLayerOverlay(shown, onRemove) {
